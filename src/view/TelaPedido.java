		...
		okButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (txtNomeDestinatario.getText().equals("")) {
					JOptionPane.showMessageDialog(null, "O campo Nome do Destinatário é obrigatório", "AVISO",
							JOptionPane.WARNING_MESSAGE);
				}
				if (txtNomeRemetente.getText().equals("")) {
					JOptionPane.showMessageDialog(null, "O campo Nome do Remetente é obrigatório", "AVISO",
							JOptionPane.WARNING_MESSAGE);
				}
				if (txtEnderecoDestinatario.getText().equals("")) {
					JOptionPane.showMessageDialog(null, "O campo Endereço do Destinatário é obrigatório", "AVISO",
							JOptionPane.WARNING_MESSAGE);
				}
				if (txtEnderecoRemetente.getText().equals("")) {
					JOptionPane.showMessageDialog(null, "O campo Endereço do Remetente é obrigatório", "AVISO",
							JOptionPane.WARNING_MESSAGE);
				}
				if (txtPeso.getText().equals("")) {
					JOptionPane.showMessageDialog(null, "O campo Peso é obrigatório", "AVISO",
							JOptionPane.WARNING_MESSAGE);
				} else {
