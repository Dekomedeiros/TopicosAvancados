...
public class TelaRelatorio extends JDialog {
	...
	public TelaRelatorio() {
		...
		}
		{
			...
			comboBox.setModel(new DefaultComboBoxModel(new String[] {"Bau", "Carreta", "Van"}));
			comboBox.setBounds(10, 26, 89, 20);
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						if(txtMotoristaRelatorio.getText().equals("")) {
							JOptionPane.showMessageDialog(null, "O campo Motorista é obrigatório", "AVISO", JOptionPane.WARNING_MESSAGE);
						}
						else {
